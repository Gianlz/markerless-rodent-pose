...
from ..styles import DANGER_BUTTON, SECONDARY_BUTTON
...
class LabelTab(QWidget):
    ...
    def init_ui(self):
        ...
        self.keypoints_list.setSelectionMode(
    ...
    def launch_labeling(self):
        ...
        try:
            ...
            QMessageBox.critical(
                self, "Error", f"Failed to launch labeling GUI:\n{str(e)}"
            )
    ...
    def add_keypoint(self):
        ...
        if ok and name:
            try:
                ...
                QMessageBox.critical(
                    self, "Error", f"Failed to add keypoint:\n{str(e)}"
                )
    ...
    def edit_keypoint(self):
        ...
        if ok and new_name and new_name != old_name:
            try:
                ...
                QMessageBox.critical(
                    self, "Error", f"Failed to update keypoint:\n{str(e)}"
                )
    ...
    def remove_keypoint(self):
        ...
        if reply == QMessageBox.StandardButton.Yes:
            try:
                ...
                QMessageBox.critical(
                    self, "Error", f"Failed to remove keypoint:\n{str(e)}"
                )
    ...
    def remove_connection(self):
        ...
        reply = QMessageBox.question(
            self,
            "Confirm",
            f"Remove connection '{connection_text}'?",
            QMessageBox.StandardButton.Yes | QMessageBox.StandardButton.No,
        )
        ...
        if reply == QMessageBox.StandardButton.Yes:
            try:
                ...
                QMessageBox.critical(
                    self, "Error", f"Failed to remove connection:\n{str(e)}"
                )
